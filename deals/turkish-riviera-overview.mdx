...
<div class="my-16 text-center">
  ...
  <div class="mt-12">
    <a 
      href="/contact" 
      class="bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white font-bold py-3 px-8 rounded-full text-lg inline-block transition-colors shadow-md hover:shadow-lg dark:shadow-blue-900/30"
    >
      Plan Your Trip
    </a>
  </div>
