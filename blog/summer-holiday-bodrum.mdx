...
<CardGroup cols={2}>
  <Card title="Dolmuş (Minibus)" icon="bus" ariaLabel="Bus icon representing dolmuş minibus transportation">
    Local minibuses connecting all major areas. Affordable but can be crowded in summer.
  </Card>
  
  <Card title="Water Taxi" icon="anchor" ariaLabel="Anchor icon representing water taxi transportation">
    Scenic routes between coastal towns. Avoid traffic while enjoying sea views.
  </Card>
  
  <Card title="Private Driver" icon="car" ariaLabel="Car icon representing private driver service">
    Convenience and comfort for day trips. Ideal for families or groups.
  </Card>
  
  <Card title="Scooter Rental" icon="motorcycle" ariaLabel="Motorcycle icon representing scooter rental service">
